...
Listing~\ref{lst:simple-class} implementiert eine Klasse in \texttt{java}.

\begin{lstlisting}[language=Java,caption={Eine einfache Klasse},label=lst:simple-class]
class Foo {
    String bar;
}
\end{lstlisting}
